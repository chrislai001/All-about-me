...
in this field will most certainly grow on me and benefits my career progress. </p>
...
<p><img src="Image1.png" alt="Director - Sales"></p>
...
a trusting relationship with my colleagues. </p>
...
to make sure the harmony and openness in a team remains. </p>
...
flow will make the embarkment process faster.</p>
...
<p><img src="Image2.png" alt="On-time Arrival Performance"></p>
...
unload the luggage can cause serious delay<sup>7</sup>. (Paris, 2017) </p>

<p>In Australia, where
...
performance by avoiding hefty fines.</p>

<p>Another way to make
...
passenger flow a breeze. </p>

<p>The system will also
...
minutes window period for necessary reminder. </p>
...
minimize a flight to be delayed. </p>

<h2>Tools &amp; Technologies</h2>

<p>Since most airlines
...
allow pop-up alert to remind the passenger to board the plane. </p>

<p>On the gate agents and
...
sending out alert to those passengers in risk to miss the flight. </p>
...
for airline employees to track the passengers. </p>

<p>Another critical skill
...
background, but the navigation should be fairly straight forward. </p>

<p>If necessary, a trial
...
concern of been tracked by the airline for the in-terminal movement.</p>

<h2>Outcome</h2>

<p>Once the trial ended,
